locals {
  questions_list = "https://github.com/ViktorUJ/cks/blob/master/tasks/cka/labs/03/README.md"
  solutions_scripts="https://github.com/ViktorUJ/cks/blob/master/tasks/cka/labs/03/worker/files/solutions/1.md"
